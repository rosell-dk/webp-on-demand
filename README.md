...
This readme describes how to use *webp-on-demand* in an existing composer project. You can however also use webp-on-demand without composer. If you want to do that, read *install-without-composer.md*
